...
import static com.example.demo.util.DeleteFolder.deleteFolder;
import static com.example.demo.util.StreamUtil.saveStreamToFile;
...
public class MergeFile {
    ...
    public static void mergeFile(final int chunksNumber,
        ...
        //通过输出流向文件写入数据
        saveStreamToFile(s, uploadFolderPath + name);
